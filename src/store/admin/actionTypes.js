...
export const CREATE_BANK_DETAIL_REQUEST = "CREATE_BANK_DETAIL_REQUEST";
export const CREATE_BANK_DETAIL_SUCCESS = "CREATE_BANK_DETAIL_SUCCESS";
export const CREATE_BANK_DETAIL_FAILURE = "CREATE_BANK_DETAIL_FAILURE";
...
export const REMOVE_BANK_DETAIL_REQUEST = "REMOVE_BANK_DETAIL_REQUEST";
export const REMOVE_BANK_DETAIL_SUCCESS = "REMOVE_BANK_DETAIL_SUCCESS";
export const REMOVE_BANK_DETAIL_FAILURE = "REMOVE_BANK_DETAIL_FAILURE";

export const BANK_DETAIL_REQUEST = "BANK_DETAIL_REQUEST";
export const BANK_DETAIL_FAILURE = "BANK_DETAIL_FAILURE";

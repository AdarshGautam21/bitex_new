...
class Category extends Component {
	...
	remove = (id) => {
		Swal.fire({
			title: "Are you sure?",
			text: "Do you really want to delete article category?",
			icon: "warning",
	...
	toggle = (id) => {
		Swal.fire({
			title: "Are you sure?",
			text: "Do you really want to update article category?",
			icon: "warning",
			showCancelButton: true,
			confirmButtonColor: "#3085d6",
			cancelButtonColor: "#d33",
									...
									<CardBody>
										<div className="table-rep-plugin">
											...
											>
												...
												>
													<ReactDataTable
														url={`${apiUrl}/api/admin/article-categories/get_article_categories`}
